...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1991.4274160278437; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2219.179225604734; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 275.29520747903024; // x position of the perpendicular encoder (in tick units)
    }
